...
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ConfigurePowerEventReceiver.aspx.cs" Inherits="iLoveSharePoint.EventReceivers.PowerEventReceivers.Layouts.iLoveSharePoint.PowerEventReceivers.ConfigurePowerEventReceiver" DynamicMasterPageFile="~masterurl/default.master" %>
...
<asp:Content ID="Main" ContentPlaceHolderID="PlaceHolderMain" runat="server">
    ...
    <asp:CompareValidator ID="CompareValidator1" ControlToValidate="sequenceNumber" Type="Integer" Operator="GreaterThanEqual" ValueToCompare="0" runat="server" Display="Dynamic" Text="Not a valid number"  />
    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" ControlToValidate="sequenceNumber" runat="server" Display="Dynamic" Text="Not a valid number" />
    <br />
    Synchronous: &nbsp; <asp:CheckBox ID="checkBoxSynchronous" runat="server" />
    <br/>
    Script:
    <br />
...
iLove SharePoint - PowerEventReceivers
</asp:Content>

<asp:Content ID="PageTitleInTitleArea" ContentPlaceHolderID="PlaceHolderPageTitleInTitleArea" runat="server" >
My Application PageiLove SharePoint - Configure Power  <%= eventType.ToString() %> Event Receiver for <%= HttpUtility.HtmlEncode(targetName) %></asp:Content>
