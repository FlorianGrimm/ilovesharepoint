...
namespace iLoveSharePoint.WebControls
{
    public class PowerWebPartEditor : EditorPart
    {
        ...
        protected override void OnLoad(EventArgs e)
        {
            ...
            pickerScript.Append(string.Format(" var popup=window.open('/_layouts/iLoveSharePoint/PowerWebPartScriptEditor.aspx?elementId=' + elementId + '&applyButtonId={0}','PowerWebPartEditor','resizable=1,height=550,width=800');\n",
