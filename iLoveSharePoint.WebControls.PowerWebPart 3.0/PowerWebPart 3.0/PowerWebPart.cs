...
namespace iLoveSharePoint.WebControls
{
    ...
    {             
        ...
        private void EnsureUpdatePanelFixups()
        {
            ...
            ScriptManager.RegisterStartupScript(this, typeof(PowerWebPart), "UpdatePanelFixup", "_spOriginalFormAction = document.forms[0].action; _spSuppressFormOnSubmitWrapper=true;", true);
        }
